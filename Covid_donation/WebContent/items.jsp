...
<div class="w3-main" style="margin-left:300px;margin-top:0px;">
  ...
  <div class="w3-container">
    <font color=blue><b><h1>Available items</h1></b></font>
...
String sql ="select * from donated_items where status='Pending' OR status='pending'";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr class="size1"> 
<%String idd=resultSet.getString("donatedby");
int id3 = Integer.parseInt(idd);%>
	
<td><%=resultSet.getString("item_no") %></td>
<td><%=resultSet.getString("itemname") %></td>
<td><%=resultSet.getString("quantity") %></td>
<td><%=resultSet.getString("donated_date") %></td>
<td><%=resultSet.getString("donatedby") %></td>
</tr>
<%
}
connection.close();
