...
<img src="corona.jpeg" style="width: 250px;height :65px;">
     ...
     <a href="feedbackform1.jsp" class="active">Feedback</a>
       <a href="trackc.jsp" class="active">Track</a>
	   <a href="User_charitydonor.jsp" class="active">Home</a>
...
<p style = "text-align:left; font-weight: bold; font-size : 20px;font-family: Algerian;color : red;"><%out.println("Your Donated Item Details.."); %></p>
...
String sql ="select * from donated_items where donatedby='"+iid+"'";
resultSet = statement.executeQuery(sql);
while(resultSet.next())
{
%>
<h3>Donated Item : <hk> <%=resultSet.getString("itemname") %></hk><br></h3>
<h3>Donated Quantity: <hk> <%=resultSet.getString("quantity") %> </hk><br></h3>
<h3> Donated_date: <hk><%=resultSet.getString("donated_date") %></hk><br></h3>
