...
<img src="corona.jpeg" style="width: 250px;height :65px;">
     ...
     <a href="feedbackform1.jsp" class="active">Feedback</a>
	   ...
	   <a href="track_user_receiver.jsp" class="active">Back</a>
	</div></div>
...
String sql ="select * from received_items where receivedby='"+iid+"'";
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql1 ="select * from selfdonor where sdonor_id='"+donor+"'";
resultSet1 = statement.executeQuery(sql1);
while(resultSet1.next()){
%>
<h3>Donor Name : <hk><%=resultSet1.getString("sfname") %> <%=resultSet1.getString("slname") %></hk><br></h3>
<h3>Donor Address:<hk> <%=resultSet1.getString("saddress") %></hk> <br></h3>
<h3>Donor Phone Number: <hk> <%=resultSet1.getString("sphno") %></hk><br></h3>
<h3>Donor Email ID: <hk><%=resultSet1.getString("semail") %></hk><br></h3>
<%
}
}
%>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql1 ="select * from charitydonor where cdonor_id='"+donor+"'";
resultSet1 = statement.executeQuery(sql1);
while(resultSet1.next()){
%>
<h3>Donor Name : <hk><%=resultSet1.getString("cname") %> </hk><br></h3>
<h3>Donor Address:<hk> <%=resultSet1.getString("caddress") %></hk> <br></h3>
<h3>Donor Phone Number: <hk> <%=resultSet1.getString("cphno") %></hk><br></h3>
<h3>Donor Email ID: <hk><%=resultSet1.getString("cemail") %></hk><br></h3>
<%
}
}
%>
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql3 ="select * from requested_items where requestedby='"+iid+"'";
