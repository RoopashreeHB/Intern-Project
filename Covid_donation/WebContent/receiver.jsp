...
<div class="w3-main" style="margin-left:300px;margin-top:0px;">
 <form class = "forms" action="search.jsp" method="post">
  <font color=White size=20px ><b><h1>RECEIVER DETAILS</h1></b></font> 
   
    <div class="topnav" style="margin-left:620px;margin-top:10px;" >
...
%>
  ...
  <div align="right"><br>
	<a href="receiver.jsp" ><button type="button" id="button3" style="margin-right: 60px"><b><< Back </b></button>  </a>
	<a href="receiver_reg.jsp" ><button type="button" id="button1" style="margin-right:20px"><b>Add</b></button>  </a>
	</div>
