...
if(name.equals("c"))
{
	String sql ="select * from charitydonor where cname LIKE '%"+searchn+"%' OR caddress LIKE '%"+searchn+"%' OR cphno LIKE '%"+searchn+"%' OR  cemail LIKE '%"+searchn+"%'";
...
<%} %><td><a href="delete_charitydonor.jsp?id=<%=resultSet.getString("cdonor_id") %>"><button type="button" class="delete"><b>Delete</b></button></a>
	</td><td><a href="self_edit.jsp?id=<%=resultSet.getString("cdonor_id") %>"><button type="button" class="edit"><b>Edit </b></button>  </a></td>
</tr>
<%
}
}
...
%>
  ...
  <div align="right">
	<br><br><a href="donor_info1.jsp" ><button type="button" id="button3" style="margin-right: 20px"><b><< Back </b></button>  </a>
	</div>
