...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-left:298px;margin-top:0px;">
 <form class = "forms" action="search_selfdonor.jsp" method="post">
  <font color=White size=20px ><b><h1>SELF-DONOR DETAILS</h1></b></font> 
...
%>
  ...
  <div align="right"><br>
	<a href="donor.jsp" ><button type="button" id="button3" style="margin-right: 20px"><b><< Back </b></button>  </a>
	<a href="selfdonor_reg.jsp" ><button type="button" id="button1" style="margin-right:100px"><b>Add</b></button>  </a><br><br>
	</div>
